...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  MT(MOD_LALT, KC_Z),KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         MT(MOD_RALT, KC_SLASH),MT(MOD_RSFT, KC_BSPC),
                                                    MO(1),          MT(MOD_LGUI, KC_ENTER),                                MT(MOD_RGUI, KC_SPACE),MO(2)
  ),
  [1] = LAYOUT_voyager(
